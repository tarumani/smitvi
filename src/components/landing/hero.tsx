    ...
    <section className="relative isolate overflow-hidden">
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100svh-4rem)] w-full max-w-6xl items-center gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12 lg:py-16">
        <div className="max-w-xl">
          ...
          <h1 className="animate-fade-up-delay-1 mt-6 font-display text-[clamp(1.6rem,3vw,2.6rem)] font-semibold leading-[1.12] tracking-tight">
            {APP_TAGLINE}
          </h1>
          <p className="animate-fade-up-delay-2 mt-5 max-w-md text-base leading-relaxed text-[var(--muted-foreground)] sm:text-lg">
        ...
        <div className="animate-fade-up-delay-2 relative lg:pl-4">
